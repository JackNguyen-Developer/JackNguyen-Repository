...
public class Main extends FragmentActivity implements MusicManager.ManagerMusicListener,SeekBar.OnSeekBarChangeListener,ActionBar.TabListener{
	//DrawerLayout and ViewPager
    ...
    private String[] tabs = {"Song", "Album", "Artist", "Playlist", "Genre", "Type"};
    //component layout  
	...
	//component drawer
	private TextView fill_all, fill_album, fill_artist, fill_playlist, fill_genre, fill_type;
	//static
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		arrayView.add(inflater.inflate(R.layout.fragment, null));
		arrayView.add(inflater.inflate(R.layout.fragment, null));
		viewAdapter = new ViewPagerAdapter_Common(arrayView, getApplicationContext(), Main.this);
		...
		registerReceiver(br , new IntentFilter("com.project.projectmusic.PREVIOUS"));
	...
	private void handleDrawerLayout()
	{
		...
		actionBarDrawerToggle = new ActionBarDrawerToggle(this, drawerLayout, R.drawable.menu_item, R.string.drawer_open, R.string.drawer_close){
	...
	BroadcastReceiver br = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			//registerReceiver(this, new IntentFilter("com.project.projectmusic.NO"));
